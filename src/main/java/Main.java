            ...
            while(true){
                ...
                if(command.equals("help")){
                    System.out.println("printInvoice - Prints invoice as a PDF file. Takes 1 optional argument - path of the PDFs directory.\n\n" +
                            ...
                            "addOrders - Adds new(or alters an existing) order entitty and returns its id. Takes optional arguments: -id <alteredEntityId>, -cid <customerId>, -eid <employeeId>, -od <orderDetails>, -sv <shipVia>. -id argument makes it so the command alters an existing entity. \n\n" +
                            "addProducts - Adds new(or alters an existing) product entitty and returns its id. Takes optional arguments: -id <alteredEntityId>, . -id argument makes it so the command alters an existing entity. \n\n" +
                            "addShippers - Adds new(or alters an existing) shipper entitty and returns its id. Takes optional arguments: -id <alteredEntityId>, . -id argument makes it so the command alters an existing entity. \n\n" +
                            "addSuppliers - Adds new(or alters an existing) supplier entitty and returns its id. Takes optional arguments: -id <alteredEntityId>, . -id argument makes it so the command alters an existing entity. \n\n" +
